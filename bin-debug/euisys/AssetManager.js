 ...
 * 资产管理:加载
 */
var AssetManagerEx = (function () {
    function AssetManagerEx(m, c) {
    ...
    var d = __define,c=AssetManagerEx,p=c.prototype;
    /**
     * 加载进度界面
    ...
    p.createChildren = function () {
        ...
        this._main.stage.addChild(this.loadingView);
    ...
    */
    ...
    p.onResourceLoadComplete = function (event) {
        if (event.groupName == "preload") {
            this._main.stage.removeChild(this.loadingView);
